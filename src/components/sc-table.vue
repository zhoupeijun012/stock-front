  ...
  <div class="sc-table">
    ...
    <div class="content-warp" >
        <div class="header-row" v-for="(tableItem,index) in tableData" :key="'header-row-' + index">
            <div class="table-row" v-for="(headerItem,index) in cloumns" :key="'table-row-' + index" :title="headerItem.title" :style="{
                textAlign: headerItem.align ? headerItem.align :'center',
                color: headerItem.color ? headerItem.color :'#000',
            }">
